  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      <SheetTrigger asChild>
        <Button variant="secondary" size="icon" className="relative bg-white/80 hover:bg-white backdrop-blur-sm shadow-soft transition-smooth">
      ...
      <SheetContent className="w-full sm:max-w-lg flex flex-col h-full">
        <SheetHeader className="flex-shrink-0">
          <SheetTitle className="font-quote text-2xl">Shopping Cart</SheetTitle>
          ...
          {items.length === 0 ? (
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center space-y-4">
                ...
                <p className="font-body text-sm text-muted-foreground">Add some beautiful quote merchandise!</p>
              </div>
            </div>
          ) : (
            <>
                  ...
                  {items.map((item) => (
                    <div key={item.variantId} className="flex gap-4 p-3 bg-secondary/20 rounded-lg">
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="font-quote font-semibold truncate">{item.product.node.title}</h4>
              ...
              <div className="flex-shrink-0 space-y-4 pt-6 border-t bg-background">
                <div className="flex justify-between items-center">
                  <span className="font-quote text-xl font-semibold">Total</span>
                ...
                <Button 
                  ...
                  className="w-full bg-primary hover:bg-primary/90 shadow-soft transition-smooth font-body font-medium" 
                  size="lg"
