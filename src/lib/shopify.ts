...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'good-thought-garden-uoub4.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = 'dd895dcc18d6acab8d067d5c99bc1d32';
...
export async function storefrontApiRequest(query: string, variables: any = {}) {
  ...
  if (response.status === 402) {
    toast.error("Shopify: Payment required - Visit https://admin.shopify.com to upgrade your plan");
    return;
  }
